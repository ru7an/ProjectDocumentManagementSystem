...
<a style="text-decoration:none; color:rgb(218,39,47); float: right;" href="../Project-I"><p class="fa fa-chevron-circle-left">BACK</p></a>
<center>
<table>
  <tr>
...
<?php
  ...
  $sql = "SELECT * FROM project1 WHERE college = '$college' AND proposal = 'Accepted' ORDER BY id DESC";
