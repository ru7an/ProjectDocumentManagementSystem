<?php
$display_team = "SELECT * FROM project1 WHERE email = '$email' OR mem1_email = '$email' OR mem2_email = '$email'";
...
<div class="center">
  ...
  <?php }?>
    ...
    <tr>
      <td>Programming Language/ Platform/Description :</td>
    ...
    <tr>
      ...
      <td><input type="file" required style="background:rgb(218, 39, 47); color:aliceblue" id="filepro" name="filepro"></td>
    </tr>
  </table>
...
<?php
  ...
  if(isset($_POST['prosubmit']))
  {
    ...
    if(mysqli_query($conn,$insert_document))
    {
      ...
      $sql = "UPDATE project1 SET proposal = 'pending...' WHERE id = '$id_no'";
      ...
      $msg = "Team no #$id has submitted proposal for Project-I.";
