...
<?php
$check_email="SELECT * FROM project2 WHERE id = '$id'";
...
if(mysqli_num_rows($check)>0)
{
  ...
  if($proposal=='pending...' || $proposal=='Rejected' || $proposal=='Re-demo')
  {
    ...
    <div id="marksheet" class="markbox">
      ...
      <table style="width:100%; margin-bottom: 15px;">
        ...
        <input type="text" value="Project-II" name="project_type" readonly style="display:none;">
  ...
  if(isset($_POST['accept']))
  {
    ...
    $sql= "UPDATE project2 SET proposal='$status', mid = 'pending...' WHERE id='$id_no'";
    ...
    {
      $sql_del = "DELETE FROM documents WHERE project_no = '$id_no' AND project_type = 'Project-II'";
        if(mysqli_query($conn,$sql_del))
        {
          //notification
          $find_project = "SELECT * FROM project2 WHERE id='$id_no'";
          ...
          $msg = "Your submitted proposal for Project-II has been $status.";
          $add_note = "INSERT INTO notificat (email_note,notify,project_type,status_note,sender) VALUES ('$email1','$msg','Project-II','stall','$user_here')";
          ...
          {
            $msg = "Your submitted proposal for Project-II has been $status.";
            $add_note = "INSERT INTO notificat (email_note,notify,project_type,status_note,sender) VALUES ('$email2','$msg','Project-II','stall','$user_here')";
            if(mysqli_query($conn,$add_note))
            {}
          }
          ...
          {
            $msg = "Your submitted proposal for Project-II has been $status.";
            $add_note = "INSERT INTO notificat (email_note,notify,project_type,status_note,sender) VALUES ('$email3','$msg','Project-II','stall','$user_here')";
            if(mysqli_query($conn,$add_note))
            {}
          }
    ...
    {
      $sql= "INSERT INTO statement(proposal_statement, mid_statement, final_statement, project_no, project_type) VALUES ('$statement_c', '', '', '$id_no','Project-II')";
      if(mysqli_query($conn,$sql))
      {
        echo "<meta http-equiv='refresh' content='0'>";
      }
      $sql= "INSERT INTO marksheet(mem1_marks, mem2_marks, mem3_marks, project_no, project_type, def_type) VALUES ('$m1_marks', '$m2_marks', '$m3_marks', '$id_no', 'Project-II', 'proposal')";
      if(mysqli_query($conn,$sql))
      {
        echo "<meta http-equiv='refresh' content='0'>";
        //notification
...
if(isset($_POST['set_sup']))
{
    ...
    $user_here = $_SESSION['email'];
    $up_sup = "UPDATE project2 SET sup_email = '$sup_e' ,sup_name = '$sup_n' WHERE id = '$id_no'";
    if(mysqli_query($conn,$up_sup))
    {
      ...
      $add_note2 = "INSERT INTO notificat (email_note,notify,project_type,status_note,sender) VALUES ('$sup_e','$msg2','Project-II','stall','$email1')";
      if(mysqli_query($conn,$add_note2))
      {}

      $msg = "$sup_n has been assigned as your Project-II supervisor.";
      $add_note = "INSERT INTO notificat (email_note,notify,project_type,status_note,sender) VALUES ('$email1','$msg','Project-II','stall'.'$user_here')";
      if(mysqli_query($conn,$add_note))
      {}
...
if(isset($_POST['f_accept']))
{
  ...
  $sql= "UPDATE project2 SET final='$status' WHERE id='$id_no'";
  if(mysqli_query($conn,$sql))
  {
    echo "<meta http-equiv='refresh' content='0'>";
  }

  $sql2 = "UPDATE statement SET final_statement='$statement_c' WHERE id='$id_no' AND project_type='Project-II'";
  if(mysqli_query($conn,$sql2))
  {
    echo "<meta http-equiv='refresh' content='0'>";
  }

  $sql= "INSERT INTO marksheet(mem1_marks, mem2_marks, mem3_marks, project_no, project_type, def_type) VALUES ('$m1_marks', '$m2_marks', '$m3_marks', '$id_no', 'Project-II', 'final')";
  if(mysqli_query($conn,$sql))
  {
    $find_project = "SELECT * FROM project2 WHERE id='$id_no'";
      $run_find = mysqli_query($conn,$find_project);
      ...
      $user_here = $_SESSION['email'];
    $msg = "Your submitted final for Project-II has been $status.";
    $add_note = "INSERT INTO notificat (email_note,notify,project_type,status_note,sender) VALUES ('$email1','$msg','Project-II','stall','$user_here')";
    if(mysqli_query($conn,$add_note))
    {}
...
{
 $sqlp = "SELECT * FROM marksheet WHERE project_no = '$id_no' AND def_type='proposal' AND project_type = 'Project-II'";
 ...
 <?php
 $sqlm = "SELECT * FROM marksheet WHERE project_no = '$id_no' AND def_type='mid' AND project_type = 'Project-II'";
 ...
 <?php
 $sqlf = "SELECT * FROM marksheet WHERE project_no = '$id_no' AND def_type='final' AND project_type = 'Project-II'";
