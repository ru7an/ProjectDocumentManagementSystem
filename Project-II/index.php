...
<div class="center-b"><h2>Project-II</h2>
  ...
  if(mysqli_num_rows($run_check)>0)
  {
    ...
    if($role=='student')
    {
      $check = "SELECT * FROM project2 WHERE email='$email' OR mem1_email='$email' OR mem2_email='$email'";
      ...
      if(mysqli_num_rows($run))
      {
        ...
        if($mem1!="" AND $mem2!="")
        {
          $check = "SELECT * FROM documents WHERE project_no='$id_no' AND project_type = 'Project-II'";
