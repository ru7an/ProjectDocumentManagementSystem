...
<?php
    ...
    $id = $_GET['id'];
    $team_info = "SELECT * FROM project2 WHERE id = '$id'";
    ...
    $team_inform = "SELECT * FROM documents WHERE project_no = '$id' AND project_type = 'Project-II'";
  ...
  <div class="center-b">
    ...
    <?php
    $ret_stat = "SELECT * FROM statement WHERE project_no ='$id' AND project_type = 'Project-II'";
...
<?php
  $query = "SELECT * FROM documents WHERE project_no = '$id' and def_type = 'proposal' AND project_type = 'Project-II'";
  $run_sql = mysqli_query($conn,$query);
  while($row=mysqli_fetch_array($run_sql))
  {
    $path =$row[6];
  }
  $query = "SELECT * FROM documents WHERE project_no = '$id' and def_type = 'final' AND project_type = 'Project-II'";
  $run_sql = mysqli_query($conn,$query);
  while($row=mysqli_fetch_array($run_sql))
  {
    $f_path =$row[6];
