...
<div class="center-b"><h2>Project-II</h2>
<a style="text-decoration:none; color:rgb(218,39,47); float: right;" href="../Project-II"><p class="fa fa-chevron-circle-left">BACK</p></a>
<center>
<table>
  <tr>
...
<?php
  ...
  $sql = "SELECT * FROM project2 WHERE college = '$college' AND proposal = 'Accepted' ORDER BY id DESC";
