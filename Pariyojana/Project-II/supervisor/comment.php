...
if($mid=='pending...' || $mid=='Rejected')
{
  ...
  if(isset($_POST['m_accept']))
  {
    ...
    $sql= "UPDATE project2 SET mid='$status' WHERE id='$id'";
    if(mysqli_query($conn,$sql))
    {
      echo "<meta http-equiv='refresh' content='0'>";;
    }

    $sql2 = "UPDATE statement SET mid_statement='$statement_c' WHERE project_no='$id' AND project_type = 'Project-II'";
    ...
    {
      //notification
      $find_project = "SELECT * FROM project2 WHERE id='$id'";
      ...
      $msg = "Your mid for Project-II has been $status.";
...
?>
<?php
$disp_cmt="SELECT * FROM comment WHERE project_no = '$id' AND project_type = 'Project-II'";
...
$sql="INSERT INTO comment(email,user_name,project_no,project_type,comment,role)VALUES('$user_now', '$user','$id', 'Project-II', '$comment','Supervisor')";
if(mysqli_query($conn,$sql))
{
  $find_project = "SELECT * FROM project2 WHERE id='$id'";
  $run_find = mysqli_query($conn,$find_project);
  ...
  $msg = "$user has commented on your Project-II.";
  $add_note = "INSERT INTO notificat (email_note,notify,project_type,status_note,sender) VALUES ('$email1','$msg','Project-II','stall','$user_here')";
  if(mysqli_query($conn,$add_note))
  {}
