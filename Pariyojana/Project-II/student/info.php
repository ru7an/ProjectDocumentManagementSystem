<?php
$display_team = "SELECT * FROM project2 WHERE email = '$email' OR mem1_email = '$email' OR mem2_email = '$email'";
...
<?php
  ...
  if(isset($_POST['prosubmit']))
  {
    ...
    if(mysqli_query($conn,$insert_document))
    {
      ...
      $sql = "UPDATE project2 SET proposal = 'pending...' WHERE id = '$id_no'";
      ...
      $msg = "Team no #$id has submitted proposal for Project-II.";
