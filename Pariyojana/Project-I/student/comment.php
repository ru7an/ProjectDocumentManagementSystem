...
?>
<?php
$disp_cmt="SELECT * FROM comment WHERE project_no = '$id_no' AND project_type = 'Project-I'";
...
$sql="INSERT INTO comment(email,user_name,project_no,project_type,comment,role)VALUES('$user_now', '$user','$id_no', 'Project-I', '$comment','Student')";
if(mysqli_query($conn,$sql))
{
  ...
  $msg = "$user has commented on his Project-I.";
  $add_note = "INSERT INTO notificat (email_note,notify,project_type,status_note,sender) VALUES ('$superv','$msg','Project-I','stall','$email')";
  ...
  if($name1!=$user)
      {
        ...
        $add_note = "INSERT INTO notificat (email_note,notify,project_type,status_note,sender) VALUES ('$email1','$msg','Project-I','stall','$email')";
        if(mysqli_query($conn,$add_note))
        {}
      }
  ...
  if($email2!='none')
      {
        ...
        {
          $msg = "$user has commented on your Project-I.";
          $add_note = "INSERT INTO notificat (email_note,notify,project_type,status_note,sender) VALUES ('$email2','$msg','Project-I','stall','$email')";
          if(mysqli_query($conn,$add_note))
          {}
        }
      }
      ...
      if($email3!='none')
      {
        ...
        {
          $msg = "$user has commented on your Project-I.";
          $add_note = "INSERT INTO notificat (email_note,notify,project_type,status_note,sender) VALUES ('$email3','$msg','Project-I','stall','$email')";
          if(mysqli_query($conn,$add_note))
          {}
        }
      }
