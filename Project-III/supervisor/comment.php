...
if($mid=='pending...' || $mid=='Rejected')
{
  ...
  if(isset($_POST['m_accept']))
  {
    ...
    $sql= "UPDATE project3 SET mid='$status' WHERE id='$id'";
    if(mysqli_query($conn,$sql))
    {
      echo "<meta http-equiv='refresh' content='0'>";;
    }

    $sql2 = "UPDATE statement SET mid_statement='$statement_c' WHERE project_no='$id' AND project_type = 'Project-III'";
    ...
    {
      //notification
      $find_project = "SELECT * FROM project3 WHERE id='$id'";
      ...
      $msg = "Your mid for Project-III has been $status.";
...
?>
<?php
$disp_cmt="SELECT * FROM comment WHERE project_no = '$id' AND project_type = 'Project-III'";
...
$sql="INSERT INTO comment(email,user_name,project_no,project_type,comment,role)VALUES('$user_now', '$user','$id', 'Project-III', '$comment','Supervisor')";
if(mysqli_query($conn,$sql))
{
  $find_project = "SELECT * FROM project3 WHERE id='$id'";
  $run_find = mysqli_query($conn,$find_project);
