...
<?php
 ...
 <form method="POST">
  <table class="note_this_css">
    ...
    <tr><td>Heading :</td><td><input type="text" placeholder="Guides Heading" style="width:100%;" name="heading"></td></tr>
    <tr><td>Guides : </td><td><textarea placeholder="Write here!" style="width:500px; height:150px; resize:none;" name="message"></textarea></td></tr>
...
if(isset($_POST['note_this']))
{
  ...
  $sql_publish="INSERT INTO guides(admin_no,college,heading,guides)VALUES('$ad_id', '$college', '$heading', '$message')";
 ...
 $get_head = "SELECT * FROM guides WHERE college='$college' ORDER BY id DESC";
 ...
 ?>
 <ul>
   <li><a style="text-decoration:none;" class="headline" href="guide_no.php?id=<?php echo"$id" ?>"><?php echo"$heading"; ?></a></li>
   </ul>
 <?php }?>
 </div>